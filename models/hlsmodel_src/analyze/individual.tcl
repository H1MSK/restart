...
add_files -cflags "-DNodeType=Linear<376,64> -I.." top_pg.cpp
...
open_solution -flow_target vivado sol
add_files -cflags "-DNodeType=Linear<64,64> -I.." top_pg.cpp
create_clock -period 500MHz
set_part xc7z020-clg400-2
set_top top_forward_p
...
open_solution -flow_target vivado sol
add_files -cflags "-DNodeType=Linear<64,17> -I.." top_pg.cpp
create_clock -period 500MHz
set_part xc7z020-clg400-2
set_top top_forward_p
...
open_solution -flow_target vivado sol
add_files -cflags "-DNodeType=Tanh<64> -I.." top_g.cpp
create_clock -period 500MHz
set_part xc7z020-clg400-2
set_top top_forward
...
open_solution -flow_target vivado sol
add_files -cflags "-DNodeType=Exp<17> -I.." top_g.cpp
create_clock -period 500MHz
set_part xc7z020-clg400-2
set_top top_forward
