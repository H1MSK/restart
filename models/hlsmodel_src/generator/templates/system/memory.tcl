...
connect_bd_intf_net [get_bd_intf_pins nn_ip/$porta] [get_bd_intf_pins $mux_name/P1]
connect_bd_intf_net [get_bd_intf_pins $mux_name/O] [get_bd_intf_pins $mem_name/BRAM_PORTA]

connect_bd_intf_net [get_bd_intf_pins nn_ip/$portb] [get_bd_intf_pins $mem_name/BRAM_PORTB]
