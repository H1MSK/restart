...
connect_bd_intf_net [get_bd_intf_pins backward/$porta] [get_bd_intf_pins $mux_name/P1]
connect_bd_intf_net [get_bd_intf_pins $mux_name/O] [get_bd_intf_pins $mem_name/BRAM_PORTB]

connect_bd_intf_net [get_bd_intf_pins forward/$porta] [get_bd_intf_pins $mem_name/BRAM_PORTA]
